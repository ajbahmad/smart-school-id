              ...
              <div class="card">
                <div class="card-body p-2">
                  ...
                  <div class="card-body little-profile text-center p-9">
                    <div class="pro-img">
                      <img src="assets/images/profile/user-2.jpg" alt="user" class="rounded-circle shadow-sm"
                        width="112" />
                    </div>
                    ...
                    <a href="javascript:void(0)" class="py-4 hstack px-7 gap-3">
                      ...
                      <div class="v-middle d-md-flex align-items-center w-100">
                        <div class="text-truncate">
                          <h5 class="mb-1 text-dark font-weight-medium fs-4">
                            James Smith
                          </h5>
                        ...
                        <div class="ms-auto d-flex button-group gap-1">
                          <button type="button" href="javascript:void(0)"
                            class="btn btn-sm bg-danger-subtle text-danger round-sm rounded-pill m-0 d-flex align-items-center">
                            <i class="ti ti-video fs-6"></i>
                          </button>
                          <button type="button" href="javascript:void(0)"
                            class="btn btn-sm bg-primary-subtle text-primary round-sm rounded-pill m-0 d-flex align-items-center">
                            <i class="ti ti-phone-incoming fs-6"></i>
                          </button>
                        </div>
                      </div>
                    </a>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <ul class="nav nav-tabs profile-tab nav-justified gap-9 my-7" role="tablist">
                    <li class="nav-item">
                      <a class="nav-link px-3 py-9 vstack gap-6 align-items-center text-center" data-bs-toggle="tab"
                  ...
                  <div class="tab-content">
                    <div class="tab-pane" id="profile" role="tabpanel">
                      <div class="card-body">
                        ...
                        <div class="progress">
                          <div class="progress-bar text-bg-secondary" role="progressbar" aria-valuenow="80"
                            ...
                            <div>
                              <div class="d-md-flex align-items-center justify-content-between gap-6 mb-6">
                                <div class="hstack gap-6">
                                  <h5 class="mb-0">
                                    <a href="javascript:void(0)" class="link fs-4">John Doe</a>
                                  </h5>
                              ...
                              <div class="row gx-9">
                                <div class="col-lg-3 col-md-6 mb-3 mb-lg-0">
                                  <img src="assets/images/blog/blog-img1.jpg" alt="user" class="rounded-1 w-100"
                                    height="80" />
                                </div>
                                <div class="col-lg-3 col-md-6 mb-3 mb-lg-0">
                                  <img src="assets/images/blog/blog-img2.jpg" alt="user" class="rounded-1 w-100"
                                    height="80" />
                                </div>
                                <div class="col-lg-3 col-md-6 mb-3 mb-lg-0">
                                  <img src="assets/images/blog/blog-img3.jpg" alt="user" class="rounded-1 w-100"
                                    height="80" />
                                </div>
                                <div class="col-lg-3 col-md-6 mb-3 mb-lg-0">
                                  <img src="assets/images/blog/blog-img4.jpg" alt="user" class="rounded-1 w-100"
                                    height="80" />
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="sl-right w-100">
                            <div>
                              <div class="d-md-flex align-items-center justify-content-between gap-6 mb-6">
                                <div class="hstack gap-6">
                                  <h5 class="mb-0">
                                    <a href="javascript:void(0)" class="link fs-4">Canry Smith</a>
                                  </h5>
                                  <span class="sl-date text-muted fs-3">5 minutes ago</span>
                                </div>
                                <iconify-icon icon="solar:menu-dots-line-duotone" class="fs-7"></iconify-icon>
                          ...
                          <div class="sl-right w-100">
                            <div>
                              <div class="d-md-flex align-items-center justify-content-between gap-6 mb-6">
                                <div class="hstack gap-6">
                                  <h5 class="mb-0">
                                    <a href="javascript:void(0)" class="link fs-4">James Smith</a>
                                  </h5>
                                  <span class="sl-date text-muted fs-3">5 minutes ago</span>
                                </div>
                                <iconify-icon icon="solar:menu-dots-line-duotone" class="fs-7"></iconify-icon>
                              ...
                              <div class="row gx-9 mb-9">
                                <div class="col-lg-5">
                                  <div class="hstack gap-3 border rounded-2 px-7 py-9">
                                    <img src="assets/images/svgs/icon-zip.svg" alt="user"
                                      class="img-fluid flex-shrink-0" />
                                    <div>
                                      <h5 class="fs-4">Payments.zip</h5>
                                ...
                                <div class="col-lg-5">
                                  <div class="hstack gap-3 border rounded-2 px-7 py-9">
                                    <img src="assets/images/svgs/icon-figma2.svg" alt="user"
                                      class="img-fluid flex-shrink-0" />
                                    <div>
                                      <h5 class="fs-4">Payments.zip</h5>
                                      <p class="mb-0 fs-3">150kb</p>
                          ...
                          <div class="form-group mb-3">
                            ...
                            <div class="col-md-12">
                              <input type="email" placeholder="johnathan@admin.com"
                                class="form-control form-control-line" name="example-email1" id="example-email1" />
                            </div>
                          </div>
                          <div class="form-group mb-3">
