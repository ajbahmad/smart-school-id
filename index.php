...
<<<<<<< HEAD
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="laporan.html" aria-expanded="false">
                <iconify-icon icon="solar:checklist-minimalistic-linear"></iconify-icon>
                <span class="hide-menu">Laporan</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="jadwal.html" aria-expanded="false">
...
=======
              <a class="sidebar-link" href="./scan-siswa.html" aria-expanded="false">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="master-kelas.html" aria-expanded="false">
                <iconify-icon icon="mdi:chart-bar"></iconify-icon>
                <span class="hide-menu">Master Kelas</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="./index.html" aria-expanded="false">
...
>>>>>>> c075c67 (add: update custom.css, index.html dan halaman master kelas)
  ...
  <div class="row">
    <div class="col-md-4">
      <div class="card text-center" style="background:#d4f8f2;">
        <div class="card-body">
          <h1 class="fw-bold">534</h1>
          <p class="mb-0 fw-semibold">TOTAL SISWA</p>
        </div>
      </div>
    </div>
    <div class="col-md-4">
      <div class="card text-center" style="background:#f7d7f7;">
        <div class="card-body">
          <h1 class="fw-bold">534</h1>
          <p class="mb-0 fw-semibold">TOTAL ABSEN</p>
        </div>
      </div>
    </div>
    <div class="col-md-4">
      <div class="card text-center" style="background:#fff3c4;">
        <div class="card-body">
          <h1 class="fw-bold">534</h1>
          <p class="mb-0 fw-semibold">TOTAL BELUM ABSEN</p>
        </div>
      </div>
      </main>
    </div>
