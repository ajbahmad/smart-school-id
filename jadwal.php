    ...
    <div class="body-wrapper">
      ...
      <main>
        ...
        <div class="container-fluid">
          <h2 class="mb-4 fw-bold">Jadwal Absen</h2>

            <!-- Table -->
            <div class="card shadow-sm">
              <div class="card-body">
                <div class="col-md-12 text-end pb-4">
                    <a href="tambah-jadwal.php" class="btn btn-secondary text-black">Add Data</a>
                  </div>
                  ...
                  <table class="table table-striped table-hover">
                    ...
                    <tbody>
                      <tr class="text-center">
                        ...
                        <td>11:20</td>
                        <td>
                            <a href="edit-jadwal.php" class="btn btn-sm btn-warning me-2">Edit</a>
                        </td>
                      </tr>
                      <tr class="text-center">
                        <td>2</td>
