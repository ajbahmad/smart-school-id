      ...
      <main>
        <div class="body-wrapper-inner">
          <div class="container-fluid">
            <h2 class="mb-4 fw-bold">Edit Pengguna</h2>
            <div class="row">
              <div class="col-md-6">
                  ...
                  <div class="card-body">
                    <form>
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nama" placeholder="Masukkan nama lengkap" value="Padli" required>
                      </div>
                      
                      <!-- Username -->
                      <div class="mb-3">
                        <label for="username" class="form-label">Username</label>
                        <input type="text" class="form-control" id="username" placeholder="Masukkan username" value="padli" required>
                      </div>
                      ...
                      <div class="mb-4">
                        ...
                        <input type="password" class="form-control" id="password" placeholder="Masukkan password" value="smkamt2025" required>
                        <div class="form-text">Minimal 8 karakter</div>
                      </div>
                      
                      <!-- Tombol Aksi -->
                      <div class="d-flex justify-content-end gap-3">
                        <a href="pengguna.php" class="btn btn-outline-danger">
